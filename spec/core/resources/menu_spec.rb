...
RSpec.describe Bls::Core::Menu do
  describe ".retrieve_all" do
    it "returns the menus" do
      ...
      result = Bls::Core::Menu.retrieve_all
  ...
  describe ".retrieve" do
    it "returns the menu" do
      ...
      result = Bls::Core::Menu.retrieve(menu_id)
    ...
    it "assigns correct number of items" do
      ...
      stub_api_v1_authentication
      stub_api_response response: response
      menu = Bls::Core::Menu.retrieve(menu_id)
    ...
    context "the id does not match a menu" do
      it "raises a Bls::Core::ResourceRetrievalError error" do
        menu_id = "2023-01-01"
        ...
        expect {
          Bls::Core::Menu.retrieve(menu_id)
        }.to raise_error(Bls::Core::ResourceRetrievalError)
      end
    end
  end
end
