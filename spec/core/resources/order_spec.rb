...
RSpec.describe Bls::Core::Order do
  describe "#create!" do
    it "creates the order" do
      recipient = build(:recipient)
      menu = build(:menu, id: "2023-01-01")
      order_item = build(:order_item)
      order = Bls::Core::Order.new(menu: menu,
                                          recipient: recipient,
    ...
    it "assigns the recipient in the request body" do
      recipient = build(:recipient)
      ship_to = Bls::Core::RecipientSerializer.new(recipient).to_json
      menu = build(:menu, id: "2023-01-01")
      order = Bls::Core::Order.new(recipient: recipient, menu: menu)
      body = build_order_response
      response = build_response(body: body)
      stub_api_response response: response
    ...
    it "assigns the order items in the request body" do
      ...
      order_item_serialized = Bls::Core::OrderItemSerializer.
                              new(order_item).
                              to_json
      order = Bls::Core::Order.new(recipient: recipient, menu: menu,
                                          items: [order_item])
    ...
    context "the response code is not 201" do
      it "raises a OrderNotCreatedError" do
        ...
        expect {
          order.create!
        }.to raise_error(Bls::Core::OrderNotCreatedError)
      end
      ...
      it "marks the order as invalid" do
        ...
        begin
          order.create!
        rescue Bls::Core::OrderNotCreatedError
          # noop
        end
  ...
  describe "#cancel!" do
    ...
    context "the response code is not 204" do
      it "raises a OrderNotCancelledError" do
        ...
        expect {
          order.cancel!
        }.to raise_error(Bls::Core::OrderNotCancelledError)
      end
      ...
      it "marks the order as not valid" do
        ...
        begin
          order.cancel!
        rescue Bls::Core::OrderNotCancelledError
          # noop
        end
